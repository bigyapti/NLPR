...
def process_video():
    ...
    return render_template('result.html', input_video_path=input_video_path, output_video_path=output_video_path)
...
def process_video_file(input_video_path):
    ...
    out = cv2.VideoWriter(output_video_path, fourcc, cap.get(5), (frame_width, frame_height))
